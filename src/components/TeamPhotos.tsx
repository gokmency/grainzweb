            ...
            <div className="absolute right-3 top-3 flex gap-2">
              ...
              {activeMember?.website && (
                <a
                  ...
                  className="w-6 h-6 text-gray-400 hover:text-gray-900 transition-colors z-10 flex items-center justify-center rounded-full hover:bg-gray-100"
                  aria-label={`Visit ${activeMember.name}'s website`}
                >
